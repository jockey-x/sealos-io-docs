...
export const config = {
  matcher: [
    '/((?!api|_next/static|_next/image|images/|icons/|favicon/|docs/self-hosting/files/|favicon.ico|logo.svg|Deploy-on-Sealos.svg|sitemap.xml|llms.txt|rss.xml|ai-faqs\..*\.json).*)/',
  ],
};
